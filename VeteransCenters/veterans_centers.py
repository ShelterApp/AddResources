...
data_source_name = 'veterans_centers'
veterans_centers_scraper = VeteransCentersScraper(
    ...
    dump_collection="tmpVeteransCenters",
    dupe_collection="tmpVeteransCentersDuplicates",
